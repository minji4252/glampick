...
const SignupPage = () => {
                      ...
                      <li className="terms-item">
                        ...
                        {selectedModal === "terms" && (
                          <TermsModal
                            ...
                            title="이용약관"
                            content="제 1 조 (목적) 이 약관은 (주)글램픽 (이하 서비스)의 이용과 관련하여
        서비스 제공자와 회원 간의 권리, 의무 및 책임사항 등을 규정하는 것을
        목적으로 합니다. 제 2 조 (정의) 서비스란 (주)글램픽이 제공하는
                      ...
                      <li className="terms-item">
                        ...
                        {selectedModal === "privacy" && (
                          <TermsModal
                            ...
                            onClose={closeTermsModal}
                            title="개인정보 처리방침"
                            content="1. 개인정보의 수집 항목 및 수집 방법
  본 서비스는 회원가입, 상담, 서비스 신청 등을 위해 아래와 같은 개인정보를 수집하고 있습니다.
  - 수집 항목: 이름, 이메일, 연락처, 주소, 생년월일, 성별, 결제 정보 등
  - 수집 방법: 홈페이지, 서면 양식, 전화, 팩스를 통한 본인 확인, 고객센터 문의 등

  2. 개인정보의 수집 및 이용 목적
  수집한 개인정보는 다음의 목적을 위해 활용합니다.
  - 서비스 제공에 관한 계약 이행 및 서비스 제공에 따른 요금정산
  - 회원 관리: 회원제 서비스 이용에 따른 본인확인, 개인 식별, 부정 이용 방지와 비인가 사용 방지, 가입 의사 확인
  ...
  - 보존 항목: 이름, 이메일, 연락처 등
  - 보존 근거: 서비스 이용의 혼선 방지, 분쟁 해결 및 법령상 의무 이행"
                          />
                        )}
                      </li>
                      <li className="terms-item">
